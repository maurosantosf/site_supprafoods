...
<meta name="description" content="Suppra Foods — Operador logístico de resfriados e congelados na Grande Goiânia. Câmaras próprias, controle térmico e frota refrigerada.">
<title>Suppra Foods — Logística em Cadeia Fria</title>
<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<?php
...
$logo_url = get_template_directory_uri() . '/assets/img/logo-suppra-foods.png';
?>
...
<div class="landing-page-body">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="right">
                    ...
                    <div class="social">
                        <a href="https://www.instagram.com/supprafoods/" target="_blank"><?php echo suppra_icon('ig', 14); ?></a>
                        <a href="#" target="_blank"><?php echo suppra_icon('in', 14); ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <a href="#home" class="logo">
                    <img src="<?php echo $logo_url; ?>" alt="Suppra Foods" style="height:44px; width:auto;">
                </a>
                <nav class="nav-links">
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div>
                    <a href="#home" class="logo">
                        <img src="<?php echo $logo_url; ?>" alt="Suppra Foods" style="height:40px; width:auto; filter: brightness(0) invert(1);">
                    </a>
                ...
                <div>
                    <h4>Operação</h4>
                    <ul style="list-style:none; padding:0; display:grid; gap:10px;">
                        <li><a href="#infra">Armazenagem</a></li>
                        <li><a href="#processo">Expedição</a></li>
                        <li><a href="#processo">Entrega</a></li>
                    </ul>
                </div>
                <div>
                    <h4>Contato</h4>
            ...
            <div style="margin-top:56px; border-top:1px solid rgba(255,255,255,0.1); padding-top:22px; font-size:13px; display:flex; justify-content:space-between;">
                <span>© <?php echo date('Y'); ?> Suppra Foods · Logística</span>
    ...
    <!-- WhatsApp Fab -->
    <a href="https://wa.me/556236383994?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20a%20opera%C3%A7%C3%A3o%20log%C3%ADstica." target="_blank" class="wa-fab" style="position:fixed; right:22px; bottom:22px; background:#25D366; width:58px; height:58px; border-radius:999px; display:flex; align-items:center; justify-content:center; color:#fff; box-shadow:0 14px 34px -10px rgba(37,211,102,0.55); text-decoration:none; z-index:90;">
                ...
                <div class="modal-form-content">
                    ...
                    <div class="modal-body-step" style="margin-top:22px; display:none;">
                        ...
                        <div style="display:grid; gap:14px;">
                            <input id="lead-nome" type="text" placeholder="Nome completo" style="width:100%; padding:14px; border:1px solid var(--line); border-radius:10px;">
                            <input id="lead-email" type="email" placeholder="E-mail corporativo" style="width:100%; padding:14px; border:1px solid var(--line); border-radius:10px;">
                        </div>
                    </div>
